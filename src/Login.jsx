...
function Login(){
    ...
    return <div className="login d-flex flex-column">
        ...
        <div className="d-flex flex-column align-items-center my-5">
            ...
            <input className="form-control w-25 mt-4  py-2 text-white" type="text"  name="" placeholder="player 1 name" onChange={(e)=>setPlayer1({name : e.target.value , score:0})}></input>

            <input className="form-control w-25 mt-4  py-2 text-white" type="text" name="" placeholder="player2 name" onChange={(e)=>setPlayer2({name : e.target.value , score:0})}></input>
